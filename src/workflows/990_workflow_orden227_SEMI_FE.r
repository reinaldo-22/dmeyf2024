...
envg$EXPENV$exp_dir <- "~/buckets/b1/expw227-FE/"
envg$EXPENV$wf_dir <- "~/buckets/b1/flow227-FE/"
...
CN_canaritos_asesinos_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1601_CN_canaritos_asesinos_div_sum_mul_rot2.r"
