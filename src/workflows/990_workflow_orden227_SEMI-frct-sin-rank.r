...
envg$EXPENV$exp_dir <- "~/buckets/b1/expw227-frct-sin-rank/"
envg$EXPENV$wf_dir <- "~/buckets/b1/flow227-frct-sin-rank/"
envg$EXPENV$repo_dir <- "~/dmeyf2024/"
envg$EXPENV$datasets_dir <- "~/buckets/b1/datasets/"
envg$EXPENV$messenger <- "~/install/zulip_enviar.sh"

envg$EXPENV$semilla_primigenia <- 7
...
KA_evaluate_kaggle_semillerio <- function( pinputexps )
{
  ...
  param_local$envios_desde <- 9600L
  param_local$envios_hasta <- 10050L
