...
def lgb_gan_eval(y_pred, y_true):
    #weight = data.get_weight()
    #weight = data.weight.copy()
...
# 16% 624GB
    ...
    data.write_parquet(exp_folder+'data_x_final.parquet' )
...
last_date_to_consider = 202004
last_date_to_consider = 201909
N_least_ampliado = 30
N_bins=5
...
path_set_crudo = '/home/reinaldo/7a310714-2a6d-44bd-bd76-c6a65540eb82/DMEF/datasets/competencia_01_crudo.csv'
path_set_con_ternaria = '/home/reinaldo/7a310714-2a6d-44bd-bd76-c6a65540eb82/DMEF/datasets/competencia_02.csv'
exp_folder = '/home/reinaldo/7a310714-2a6d-44bd-bd76-c6a65540eb82/DMEF/exp/'
...
final_train= [202004,202005,202006,202007,202008,202009,202010,202011,202012,202101,202102, 202103, 202104]
...
def objective(trial):
    ...
    wait_for_cpu_usage(threshold=10, check_interval=10)
    ...
    params['neg_bagging_fraction'] = trial.suggest_float("neg_bagging_fraction", 0.02, 0.35)  # Example of leaf size    
    ...
    cant_semillas_ensamble = trial.suggest_int('cant_semillas_ensamble',20, 100)   
...
def best_trial_objective(best_trial):
    ...
    params['learning_rate'] = best_trial.suggest_float("learning_rate", 0.1, 0.7)   
    ...
    params['neg_bagging_fraction'] = best_trial.suggest_float("neg_bagging_fraction", 0.02, 0.35)  # Example of leaf size    
    params['pos_bagging_fraction'] = 1
...
#    fraction = 0.1# best_trial.suggest_float('fraction', 0.01, 1)             
    ...
    cantidad_meses = best_trial.suggest_int('cantidad_meses', 6, 12)   
