...
PARAM$experimento_data <- "PP7230_abr_safe025_cols_optuna"
PARAM$experimento <- "HT7440_PP7230_abr_safe025_cols_optuna"
...
setwd("~/buckets/b2/exp/") # Establezco el Working Directory
