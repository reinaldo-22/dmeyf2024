...
PARAM$experimento <- "PP7230_abr_safe025_cols_optuna"
...
action_limitar_memoria <- function( GB_min = 10 ) {
...
cols_to_drop <- c(
'Unnamed__0', 'cliente_edad', 'mcomisiones', 'cproductos', 'mcuenta_corriente_adicional', 'ctarjeta_debito', 'ctarjeta_debito_transacciones', 'mautoservicio', 'ctarjeta_visa', 'ctarjeta_master_transacciones', 'cprestamos_personales', 'cprestamos_hipotecarios', 'mplazo_fijo_pesos', 'cinversion2', 'cseguro_vida', 'cseguro_auto', 'cseguro_accidentes_personales', 'ccaja_seguridad', 'cpayroll_trx', 'mcuenta_debitos_automaticos', 'ctarjeta_master_debitos_automaticos', 'mttarjeta_master_debitos_automaticos', 'mpagomiscuentas', 'mcajeros_propios_descuentos', 'mtarjeta_master_descuentos', 'ccomisiones_mantenimiento', 'mcomisiones_mantenimiento', 'cforex', 'cforex_buy', 'cforex_sell', 'mforex_sell', 'ctransferencias_emitidas', 'mtransferencias_emitidas', 'cextraccion_autoservicio', 'mextraccion_autoservicio', 'mcheques_depositados', 'mcheques_emitidos_rechazados', 'tcallcenter', 'ccallcenter_transacciones', 'thomebanking', 'ccajas_consultas', 'catm_trx', 'matm', 'catm_trx_other', 'matm_other', 'cmobile_app_trx', 'Master_delinquency', 'Master_Finiciomora', 'Master_msaldototal', 'Master_msaldodolares', 'Master_mconsumosdolares', 'Master_madelantopesos', 'Master_madelantodolares', 'Master_mpagado', 'Master_mpagospesos', 'Master_cadelantosefectivo', 'Visa_status', 'Visa_mfinanciacion_limite', 'Visa_Finiciomora', 'Visa_msaldototal', 'Visa_msaldopesos', 'Visa_mconsumospesos', 'Visa_madelantopesos', 'Visa_mpagospesos', 'Visa_mpagosdolares', 'Visa_cadelantosefectivo')
