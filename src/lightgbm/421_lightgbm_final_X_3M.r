...
PARAM$input$training <- c( 202103, 202104,202105)#c(202104) # meses donde se entrena el modelo
PARAM$input$future <- c(202106) # meses donde se aplica el modelo


PARAM$finalmodel$num_iterations <- 1121#613
PARAM$finalmodel$learning_rate <- 0.0100690392039087#0.01
PARAM$finalmodel$feature_fraction <- 0.259901398263756#0.5489793063
PARAM$finalmodel$min_data_in_leaf <- 1089 #1014
PARAM$finalmodel$num_leaves <- 369#928
